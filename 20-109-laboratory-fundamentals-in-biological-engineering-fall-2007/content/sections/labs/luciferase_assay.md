...
type: course
uid: da42df1dffb9a16b951d1267c9b1d8fa

---

Modules: [2.1]({{< baseurl >}}/sections/labs/sirna_design) | [2.2]({{< baseurl >}}/sections/labs/transfection) | 2.3 | [2.4]({{< baseurl >}}/sections/labs/mod2_4) | [2.5]({{< baseurl >}}/sections/labs/mod2_5) | [2.6]({{< baseurl >}}/sections/labs/mod2_6)
...
These assays should be performed as you did last time. Refer to the [Module 2 Lab 2 protocol]({{< baseurl >}}/sections/labs/transfection) for any particulars of the assay that you may have forgotten.
...
3.  Read the following articles for a class discussion next time.
    ...
    *   The original paper, describing some work labeled "RNA activation": Li, Long-Cheng, et al. "[Small dsRNAs Induce Transcriptional Activation in Human Cells](http://www.pnas.org/cgi/content/abstract/103/46/17337)." _PNAS_ 103, no. 46 (2006): 17337-17342.
        *   Questions to guide your reading and some background information can be found on the page associated with the next lab [Module 2 Day 4]({{< baseurl >}}/sections/labs/mod2_4). **You do not have to turn in the answers** to these questions but you will be asked to guide the class discussion around some of these topics so you must come to lab familiar with the content of the articles and ready to discuss the material.
