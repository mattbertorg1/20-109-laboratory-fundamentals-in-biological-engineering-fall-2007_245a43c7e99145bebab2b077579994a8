...
title: Lab Tour
type: course
uid: d59d760698974e938741aa4918add9d8
...
5.  Be prepared to [Start up Genome Engineering]({{< baseurl >}}/sections/labs/mod1_1), by reading the introduction at that link. It describes some basic information that you'll need for the experiment that you'll start next time. Come to class next time familiar with some of the life cycle of the M13 bacteriophage as well as a copy of its [Genome Sequence](http://www.genomenewsnetwork.org/resources/whats_a_genome/Chp2_1.shtml).